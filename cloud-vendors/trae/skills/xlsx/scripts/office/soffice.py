...
def get_soffice_env() -> dict:
    ...
    On Linux/macOS: sets SAL_USE_VCLPLUGIN=svp for headless rendering (no X11),
    and applies LD_PRELOAD socket shim if AF_UNIX is blocked.
    On Windows: returns plain env (no VCL plugin or shim needed).
    """
    env = os.environ.copy()
