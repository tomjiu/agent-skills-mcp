...
Avoid successive `external_browser_evaluate`calls within‑one execution snippet. Invoke `external_browser_snapshot` to inspect the current‑page state in‑between operations.
---
