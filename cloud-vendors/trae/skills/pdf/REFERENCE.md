...
# --- Image with Caption (kept together, not split) ---
...
table.setStyle(TableStyle([
    ...
    ('FONTNAME', (0, 0), (-1, -1), cjk_font),  # Use CJK font for all cells
    ('FONTSIZE', (0, 0), (-1, 0), 14),
...
When creating charts with matplotlib for embedding in PDFs:
...
def setup_matplotlib_cjk():
    """Configure matplotlib to support CJK characters in charts"""
    system = platform.system()
    if system == "Darwin":
...
# Setup before creating any charts
cjk_font = setup_matplotlib_cjk()

# Create pie chart with Chinese labels
