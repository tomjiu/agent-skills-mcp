...
| flowchart.create_by_mermaid | 通过 Mermaid 语法创建流程图 |
...
```json
{
  ...
  "url": "https://saas.docs.qq.com/mind/DV2h5cWJ0R1lQb0lH",
  "error": "",
...
```json
{
  ...
  "url": "https://saas.docs.qq.com/flow/DV2h5cWJ0R1lQb0lH",
  "error": "",
  "trace_id": "trace_1234567890"
}
```
